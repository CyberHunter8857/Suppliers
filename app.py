...
# MongoDB Connection
client = MongoClient("mongodb+srv://admin:mayur123@cyberhunter.h1bcf.mongodb.net/?retryWrites=true&w=majority&appName=CyberHunter", tls=True, tlsAllowInvalidCertificates=False)
db = client['java_lab']
